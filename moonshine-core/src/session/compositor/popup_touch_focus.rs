...
impl TouchTarget<MoonshineCompositor> for TouchFocusTarget {
	...
	fn motion(&self, seat: &Seat<MoonshineCompositor>, data: &mut MoonshineCompositor, event: &MotionEvent, seq: Serial) {
	...
	fn orientation(&self, seat: &Seat<MoonshineCompositor>, data: &mut MoonshineCompositor, event: &OrientationEvent, seq: Serial) {
...
impl DndFocus<MoonshineCompositor> for TouchFocusTarget {
	...
	fn leave<S: Source>(&self, data: &mut MoonshineCompositor, offer: Option<&mut Self::OfferData<S>>, seat: &Seat<MoonshineCompositor>) {
		DndFocus::leave(&self.0, data, offer, seat);
	}

	fn drop<S: Source>(&self, data: &mut MoonshineCompositor, offer: Option<&mut Self::OfferData<S>>, seat: &Seat<MoonshineCompositor>) {
